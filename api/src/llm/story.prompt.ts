...
- For fictional treatment, do not claim the story really happened. factualClaims must be empty and disclosureNp must plainly label it as a fictional/कल्पित story.
...
- Copy treatment exactly. voiceoverText is the exact approved narration, lightly cleaned only for TTS.
...
- For fictional stories, do not research fictional events or mistake them for factual claims. Require an explicit fictional disclosure and factualClaims=[].
