    ...
    <div className="lnd-root">
      ...
      <nav className="lnd-nav" aria-label="Main navigation">
        ...
        <div className="lnd-nav-links">
          <a href="https://github.com/shashwotghimire/nepali-reels" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="lnd-nav-icon">
          ...
          <a href="https://reels-api.shashwotghimire.tech/api/docs" target="_blank" rel="noopener noreferrer" className="lnd-nav-icon">
            API Docs
          </a>
